...
qualification_bp.route('/user/<int:user_id>', methods=['GET'])(QualificationController.get_user_qualification)

# Update user's qualification
qualification_bp.route('/user/<int:user_id>', methods=['PUT'])(QualificationController.update_user_qualification)
